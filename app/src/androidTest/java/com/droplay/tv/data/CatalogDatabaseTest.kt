...
class CatalogDatabaseTest {
    @Test fun upsertPrunesOnlyAfterValidBatchAndRollsBackInvalidBatch() = runBlocking {
        ...
        val first = LiveStreamEntity(id, "1", "news", "Canal 1", "canal 1", "noticias", null, null, 0, "ts", false, false, false, false, false, "NONE", 2, 1)
        dao.replaceLive(id, listOf(LiveCategoryEntity(id, "news", "Notícias", "noticias", false, 2, 1)), listOf(first), SyncMetadataEntity(id, "LIVE", now, now, null, 1, 1, null, null, "Success"))
        ...
        dao.replaceLive(id, listOf(LiveCategoryEntity(id, "news", "Notícias", "noticias", false, 2, 3)), listOf(second), SyncMetadataEntity(id, "LIVE", 30, 30, null, 3, 1, null, null, "Success"))
